...
class Theme:
    ...
    def create(self, preset, is_dark=False):
        ...
        self.gtk3_vars, self.gtk3_css = self.generate_gtk_css("gtk3")
        self.gtk4_vars, self.gtk4_css = self.generate_gtk_css("gtk4")
    ...
    def generate_gtk_css(self, app_type):
        ...
        return final_css, self.custom_css.get(app_type, "")
