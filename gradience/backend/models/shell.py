...
class ShellTheme:
    ...
    def __init__(self, shell_version: int):
        if shell_version in self.shell_versions:
            ...
            raise Exception(f"Gradience doesn't support shell theming in GNOME Shell {shell_version}")
    ...
    def create_theme(self, preset: Preset):
        ...
        self.insert_variables(variables)
    ...
    def insert_variables(self, variables):
