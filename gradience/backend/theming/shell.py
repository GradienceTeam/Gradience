...
class ShellTheme:
    ...
    def set_shell_theme(self):
        if is_sandboxed():
            ...
            def _on_reset_finish(self, **kwargs):
                # Set theme generated by Gradience
                FlatpakGSettings().write_value_async(None, schema_id, key, "gradience-shell")

            # Set default theme
            FlatpakGSettings().reset_value_async(_on_reset_finish, schema_id, key)
        else:
            # Set default theme
